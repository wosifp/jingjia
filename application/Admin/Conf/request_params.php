...
return array(
	...
	'AccountInfo'=>array(
	"accountFields" => array("userId","balance","pcBalance","mobileBalance","cost","payment","budgetType","budget","regionTarget","excludeIp","openDomains","regDomain","budgetOfflineTime","weeklyBudget","userStat","isDynamicCreative","isDynamicTagSublink","isDynamicTitle","isDynamicHotRedirect","dynamicCreativeParam","userLevel")
	),
	/* 2、--------------------------------------------------------------------------------------- */
	...
	'AdgroupInfo'=>array(
	'adgroupFields'=>array('adgroupId','campaignId','adgroupName','pause','maxPrice','negativeWords','exactNegativeWords','status','accuPriceFactor','wordPriceFactor','widePriceFactor','matchPriceStatus','priceRatio','pcPriceRatio'),
	...
	'KeywordInfo' => array(
	'wordFields' =>array('keywordId','campaignId','adgroupId','keyword','price','pause','matchType','phraseType','status','wmatchprefer','pcDestinationUrl','pcQuality','pcScale','mobileDestinationUrl','mobileQuality','mobileScale','tabs','leftPriceGuide','left3PriceGuide','mPriceGuide','pcQualityFactor','mobileQualityFactor'),
	/* 查询 id 集合 idType=5；类型为单元 id，不超过 50 个 idType=11，类型为关键词id，不超过 10000 个.必填 
建议分批多次请求  */
	'ids'=>array(2139138018),
	/* 必填 */
	'idType'=>5,
	 /* 是否查询关键词影子 选填，
	 默认为 0 
...
getTemp 为 0 查询到的是 A, getTemp 为 1 查询到的是 A’.  	*/
	...
	'CreativeInfo'=>array(
	'creativeFields'=>array('creativeId','adgroupId','title','pause','status','description1','description2','pcDestinationUrl','pcDisplayUrl','mobileDestinationUrl','mobileDisplayUrl','devicePreference','tabs'),
...
链的投放设备  */
	'sublinkFields'=>array('sublinkId','adgroupId','sublinkInfos','pause','status'),
	/* 是否查询影子
必填 
0：只查询计算机推广子链接本身 
1：只查询计算机推广子链影子 
...
1：移动设备  */
	...
	'dynCreativeFields'=>array('dynCreativeId','campaignId','adgroupId','bindingType','title','url','murl','status','pause'),
	'ids'=>array(67553278),
	'idType'=>5
	),
...
体的接口描述中会有进一步描述，说明对接口有意义的属性。
	...
	'realTimeRequestType'=>array(
	'performanceData'=>array('impression','cost','cpc','click','ctr','cpm'),
	/* 选填，默认 null ，按照时间排序：  
true ：降序  
false ：升序  
app 下载报告 / 推广电话报告，不支
...
告、当物料量较大时，建议按计划或单元分批获取，一条对应三条返回值   */
	...
	'realTimeQueryRequestType'=>array(
	'performanceData'=>array('click','impression'),
	...
	'realTimePairRequestType'=>array(
	'performanceData'=>array('cost','cpc','click','impression','ctr','cpm',/* 'position', */'conversion'),
	...
	'performanceData'=>array('cost','cpc','click','impression','ctr','cpm',/* 'position', */'conversion','phoneConversion','bridgeConversion'),
	'startDate'=>'2018-01-02',
	'endDate'=>'2018-02-02',
	...
	'reportType'=>2,
	/* Longarray()  选填，默认 NULL，表示统计范围为全账户 staRange 为 3 时填写计划 id; staRange 为 5 时填写单元 id; staRange 为 7 时填写创意 id; staRange 为 11 时填写关键词 keywordid;staRange 为 6 时填写关键词 wordid  */
	'statIds'=>array(),
	...
	'includeTemp'=>true,
	'format'=>1,
	'accountFields'=>array('all'),
	'campaignFields'=>array('all'),
	'adgroupFields'=>array('all'),
	'keywordFields'=>array('all','leftPriceGuide','left3PriceGuide','mPriceGuide','pcQualityFactor','mobileQualityFactor'),
	'creativeFields'=>array('all'),
	'sublinkFields'=>array('all'),
	'mobileSublinkFields'=>array('all'),
	'phoneFields'=>array('all'),
	'bridgeFields'=>array('all'),
	'dynamicCreativeFields'=>array('all'),
	'ecallFields'=>array('all'),
	'mobileExtend'=>1
	),
